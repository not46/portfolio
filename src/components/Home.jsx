  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center mt-4 mb-4">
         <NavLink className="border-none  bg-green-500 p-2 px-4 rounded-md text-white" to="/work">View More</NavLink>
      </div>
      {/* <hr /> */}
     <br />
      <div className="flex flex-col  items-center justify-center mt-5 mb-3">
          <h1 className='flex flex-col text-2xl font-ligo'>Featured By</h1>
