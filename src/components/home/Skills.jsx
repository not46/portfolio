      ...
      <div className="container mx-auto">
        ...
        <div className="grid gap-4 lg:gap-8 grid-cols-12 ">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://res.cloudinary.com/dgymvrggo/image/upload/v1730465772/videoEdit_jmomlw.jpg')",
            }}
          >
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://res.cloudinary.com/dgymvrggo/image/upload/v1730465772/brand_raerew.jpg')",
            }}
          >
            <div className="absolute inset-0 bg-black bg-opacity-50 rounded-lg"></div>
            <h3 className="relative z-10 text-3xl font-mono text-gray-300">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://res.cloudinary.com/dgymvrggo/image/upload/v1730460783/OVERDUE-2_nw98su.jpg')",
            }}
          >
            <div className="absolute inset-0 bg-black bg-opacity-50 rounded-lg"></div>
            <h3 className="relative z-10 text-3xl font-mono text-gray-300">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://res.cloudinary.com/dgymvrggo/image/upload/v1730461328/Ipl_2_m5a1dy.jpg')",
            }}
          >
            <div className="absolute inset-0 bg-black bg-opacity-50 rounded-lg"></div>
            <h3 className="relative z-10 text-3xl font-mono text-gray-300">
