...
function Work() {
  return (
    <>
      ...
      <div className="flex items-center lg:px-6 justify-center gap-4 p-3 m-2 flex-wrap md:flex-row ">
        ...
        <div className="ml-2 mt-4">
          <img className="w-[450px] h-[370px] md:w-[60vw] lg:w-[30vw]" src="spm.gif" alt="" />
        </div>
